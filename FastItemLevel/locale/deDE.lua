local L = LibStub("AceLocale-3.0"):NewLocale("FastItemLevel", "deDE")
...
L["Only perform inspections when the Shift key is held down."] = "Führe Inspektionen nur bei gedrückter Umschalttaste durch."
